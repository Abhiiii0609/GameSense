...
class PersonDetector():
    ...
    def detect(self, image, person_min_score=0.93): 
        PERSON_LABEL = 1
    ...
    def detect_top_and_bottom_players(self, image, inv_matrix, filter_players=True):
        ...
        bboxes, probs = self.detect(image, person_min_score=0.93)
        if len(bboxes) > 0:
    ...
    def track_players(self, frames, matrix_all, filter_players=True):
        persons_top = []
        persons_bottom = []
